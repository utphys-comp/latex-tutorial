...
\begin{figure}
    \centering
    \includegraphics[height=0.58\textheight,keepaspectratio]{./figures/fig_kadai.pdf}
\end{figure}
\end{frame}
...
\begin{itemize}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=1.5cm,bb=0 0 391 183]{./figures/fig_new_file.jpg}
        \qquad
...
\begin{itemize}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=2.4cm]{./figures/Menu.pdf}\qquad
        \includegraphics[height=2.4cm]{./figures/Compiler.pdf}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=2.2cm,keepaspectratio]{./figures/fig_preview.pdf}
    \end{figure}
\end{itemize}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile,shrink=20]{\LaTeX{} とは}
...
\item \textcolor{magenta}{２つ以上の半角の空白}は詰めて表示される（全角は詰めない）
...
\begin{center}
\includegraphics[width=4cm,bb=0 0 391 183]{./figures/fig_upload.jpg}
\end{center}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item 空のファイル、文章１行だけ、タイトルだけのファイル, etc.
    \end{itemize}
